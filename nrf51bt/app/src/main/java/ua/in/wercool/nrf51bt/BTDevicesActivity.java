...
public class BTDevicesActivity extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        if (nRF51.mBluetoothAdapter == null)
        {
            ...
            Toast toast = Toast.makeText(context, "Device does not support Bluetooth", Toast.LENGTH_LONG);
            toast.show();
        }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data)
    {
        ...
        {
            Toast toast = Toast.makeText(getApplicationContext(), "Bluetooth is enabled", Toast.LENGTH_LONG);
            toast.show();
        }
    }
